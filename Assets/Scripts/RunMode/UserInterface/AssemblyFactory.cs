...
namespace Assets.Scripts.RunMode.UserInterface
{
    ...
    public class AssemblyFactory : SceneMemberInjectDependencies
    {
        ...
        public void Hide()
        {
            Routine.MovePivot(transform.GetComponent<RectTransform>(), transform.GetComponent<RectTransform>().pivot, new Vector2(0, 1), .18f); // moving animation
        }

        public void Show()
        {
            Routine.MovePivot(transform.GetComponent<RectTransform>(), transform.GetComponent<RectTransform>().pivot, new Vector2(1, 1), .18f); // moving animation
        }
