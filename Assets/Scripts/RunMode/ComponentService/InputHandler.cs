...
namespace Assets.Scripts.RunMode.ComponentService
{
    public class InputHandler : SceneMemberInjectDependencies
    {
        ...
        public void Show() => Routine.MovePivot(trashTrans, trashTrans.pivot, new Vector2(0, 0), .18f); // opening animation

        public void Hide() => Routine.MovePivot(trashTrans, trashTrans.pivot, new Vector2(0, 1), .18f); // closing animation
