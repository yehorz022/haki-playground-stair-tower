...
public static class Code {
    ...
    public static void ShiftPanel(RectTransform content, Transform parent, bool vertical, bool next, int minPanels, int totalPanels, float panelSize, float startGap, float endGap, float gap, Action<RectTransform, int> action = null) { //dir true = shift right
